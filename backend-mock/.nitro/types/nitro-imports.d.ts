declare global {
  ...
  const cachedEventHandler: typeof import('../../../node_modules/.pnpm/nitropack@2.12.4_@netlify+blobs@9.1.2_encoding@0.1.13/node_modules/nitropack/dist/runtime/internal/cache')['cachedEventHandler']
  const cachedFunction: typeof import('../../../node_modules/.pnpm/nitropack@2.12.4_@netlify+blobs@9.1.2_encoding@0.1.13/node_modules/nitropack/dist/runtime/internal/cache')['cachedFunction']
  ...
  const defineCachedEventHandler: typeof import('../../../node_modules/.pnpm/nitropack@2.12.4_@netlify+blobs@9.1.2_encoding@0.1.13/node_modules/nitropack/dist/runtime/internal/cache')['defineCachedEventHandler']
  const defineCachedFunction: typeof import('../../../node_modules/.pnpm/nitropack@2.12.4_@netlify+blobs@9.1.2_encoding@0.1.13/node_modules/nitropack/dist/runtime/internal/cache')['defineCachedFunction']
  ...
  const defineNitroErrorHandler: typeof import('../../../node_modules/.pnpm/nitropack@2.12.4_@netlify+blobs@9.1.2_encoding@0.1.13/node_modules/nitropack/dist/runtime/internal/error/utils')['defineNitroErrorHandler']
  const defineNitroPlugin: typeof import('../../../node_modules/.pnpm/nitropack@2.12.4_@netlify+blobs@9.1.2_encoding@0.1.13/node_modules/nitropack/dist/runtime/internal/plugin')['defineNitroPlugin']
  ...
  const defineRenderHandler: typeof import('../../../node_modules/.pnpm/nitropack@2.12.4_@netlify+blobs@9.1.2_encoding@0.1.13/node_modules/nitropack/dist/runtime/internal/renderer')['defineRenderHandler']
  ...
  const defineRouteMeta: typeof import('../../../node_modules/.pnpm/nitropack@2.12.4_@netlify+blobs@9.1.2_encoding@0.1.13/node_modules/nitropack/dist/runtime/internal/meta')['defineRouteMeta']
  const defineTask: typeof import('../../../node_modules/.pnpm/nitropack@2.12.4_@netlify+blobs@9.1.2_encoding@0.1.13/node_modules/nitropack/dist/runtime/internal/task')['defineTask']
  ...
  const getRouteRules: typeof import('../../../node_modules/.pnpm/nitropack@2.12.4_@netlify+blobs@9.1.2_encoding@0.1.13/node_modules/nitropack/dist/runtime/internal/route-rules')['getRouteRules']
  ...
  const nitroPlugin: typeof import('../../../node_modules/.pnpm/nitropack@2.12.4_@netlify+blobs@9.1.2_encoding@0.1.13/node_modules/nitropack/dist/runtime/internal/plugin')['nitroPlugin']
  ...
  const runTask: typeof import('../../../node_modules/.pnpm/nitropack@2.12.4_@netlify+blobs@9.1.2_encoding@0.1.13/node_modules/nitropack/dist/runtime/internal/task')['runTask']
  ...
  const useAppConfig: typeof import('../../../node_modules/.pnpm/nitropack@2.12.4_@netlify+blobs@9.1.2_encoding@0.1.13/node_modules/nitropack/dist/runtime/internal/config')['useAppConfig']
  const useBase: typeof import('../../node_modules/.pnpm/h3@1.15.3/node_modules/h3')['useBase']
  const useEvent: typeof import('../../../node_modules/.pnpm/nitropack@2.12.4_@netlify+blobs@9.1.2_encoding@0.1.13/node_modules/nitropack/dist/runtime/internal/context')['useEvent']
  const useNitroApp: typeof import('../../../node_modules/.pnpm/nitropack@2.12.4_@netlify+blobs@9.1.2_encoding@0.1.13/node_modules/nitropack/dist/runtime/internal/app')['useNitroApp']
  ...
  const useRuntimeConfig: typeof import('../../../node_modules/.pnpm/nitropack@2.12.4_@netlify+blobs@9.1.2_encoding@0.1.13/node_modules/nitropack/dist/runtime/internal/config')['useRuntimeConfig']
  const useSession: typeof import('../../node_modules/.pnpm/h3@1.15.3/node_modules/h3')['useSession']
  const useStorage: typeof import('../../../node_modules/.pnpm/nitropack@2.12.4_@netlify+blobs@9.1.2_encoding@0.1.13/node_modules/nitropack/dist/runtime/internal/storage')['useStorage']
...
export { clearRefreshTokenCookie, setRefreshTokenCookie, getRefreshTokenFromCookie } from 'D:/UGit/operationplatform-frontend/backend-mock/utils/cookie-utils';
export { generateAccessToken, generateRefreshToken, verifyAccessToken, verifyRefreshToken } from 'D:/UGit/operationplatform-frontend/backend-mock/utils/jwt-utils';
export { MOCK_USERS, MOCK_CODES, MOCK_MENUS, MOCK_MENU_LIST, getMenuIds } from 'D:/UGit/operationplatform-frontend/backend-mock/utils/mock-data';
export { useResponseSuccess, usePageResponseSuccess, useResponseError, forbiddenResponse, unAuthorizedResponse, sleep, pagination } from 'D:/UGit/operationplatform-frontend/backend-mock/utils/response';